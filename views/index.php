...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary fixed-top text-uppercase" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">WebTech</a>
    ...
    <header class="masthead bg-primary text-white text-center">
      <div class="container">
        <img class="img-fluid mb-5 d-block mx-auto" id="logo" src="views/img/analyse.png" alt="">
    ...
    <?php if ($searched) { echo gettype($test); print_r($test->responses->{'labelAnnotations'}) ?>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 mb-5 mb-lg-0">
            ...
            <p class="lead mb-0">Göttingen
              <br>Georg-August-Universität</p>
          </div>
          <div class="col-md-4 mb-5 mb-lg-0">
          ...
          <div class="col-md-4">
            <h4 class="text-uppercase mb-4">About WebTech</h4>
            <p class="lead mb-0">Innovative Ideen aus erster Hand !</p>
          </div>
        </div>
      </div>
    </footer>
    ...
    <script src="views/js/freelancer.min.js"></script>
